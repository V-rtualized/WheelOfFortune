...
| **Legendary Comeback**  | Guarantees The Soul will appear as one of the next 50 Tarot cards                                                                   | Positive | Until The Soul appears  | Implemented |
...
| D **Indigo Blessing**   | Select an additional card from all packs for the rest of the ante. Idea credit to ЗАХАРОСАН                                         | Positive | Until end of ante       | Implemented |
...
| D **Tarrot God**        | Gain +1 consumable slot for the rest of the ante                                                                                    | Positive | Until end of ante       | Implemented |
...
| D **Shop Inflation**    | Increases all shop card prices by X(1 + 0.1 \* ante). Creates an indicator joker                                                    | Negative | Until end of ante       | Implemented |
