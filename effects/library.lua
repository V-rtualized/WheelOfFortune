WOF.Effect({
	...
	on_add = function(self) WOF.default_on_add(self) end,
	on_remove = function(self) WOF.default_on_remove(self) end,
}):inject()
...
function create_card(_type, area, legendary, _rarity, skip_materialize, soulable, forced_key, key_append)
	...
	local card = create_card_ref_library(_type, area, legendary, _rarity, skip_materialize, soulable, forced_key, key_append)
	if unbanned then G.GAME.banned_keys["c_fool"] = true end
	return card
end
