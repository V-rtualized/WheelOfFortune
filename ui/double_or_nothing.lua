...
function WOF.show_double_or_nothing_ui()
	...
	local contents = {
		...
		{ n = G.UIT.R, config = { align = "cm", padding = 0.1 }, nodes = {
			{ n = G.UIT.T, config = { text = localize("k_wof_effect_double_or_nothing"), scale = 0.5, colour = G.C.WHITE, shadow = true } },
		}},
		-- Bet display
		{ n = G.UIT.R, config = { align = "cm", padding = 0.1 }, nodes = {
			{ n = G.UIT.C, config = { align = "cm", padding = 0.1, r = 0.1, colour = G.C.L_BLACK, emboss = 0.05, minw = 3 }, nodes = {
				{ n = G.UIT.T, config = {
		...
		{ n = G.UIT.R, config = { align = "cm", padding = 0.08 }, nodes = {
			UIBox_button({ col = true, ref_table = { delta = -5 }, button = "wof_don_change", func = "wof_can_don_change", label = { "-5" }, colour = G.C.BLUE, scale = 0.4, minw = 1.1, minh = 0.6 }),
			UIBox_button({ col = true, ref_table = { delta = -1 }, button = "wof_don_change", func = "wof_can_don_change", label = { "-1" }, colour = G.C.BLUE, scale = 0.4, minw = 1.1, minh = 0.6 }),
			UIBox_button({ col = true, ref_table = { delta =  1 }, button = "wof_don_change", func = "wof_can_don_change", label = { "+1" }, colour = G.C.BLUE, scale = 0.4, minw = 1.1, minh = 0.6 }),
			UIBox_button({ col = true, ref_table = { delta =  5 }, button = "wof_don_change", func = "wof_can_don_change", label = { "+5" }, colour = G.C.BLUE, scale = 0.4, minw = 1.1, minh = 0.6 }),
		}},
		-- BET button
		UIBox_button({ button = "wof_don_submit", one_press = true, label = { localize("b_wof_bet") }, colour = G.C.GREEN, scale = 0.55, minw = 4, minh = 1.0, focus_args = { nav = "wide", snap_to = true } }),
	}
